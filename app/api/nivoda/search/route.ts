...
const Body = z.object({
  filters: z.object({
    ...
    sizes: z.object({ from: z.number().min(0).max(50), to: z.number().min(0).max(50) }).optional(),
    ...
    fancyColor: z.array(z.string()).max(20).optional(),
    fancyIntensity: z.array(z.string()).max(20).optional(),
  }).default({}),
